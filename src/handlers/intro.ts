...
Раз в месяц он мэтчит вас с другим участником или другой участницей комьюнити, чтобы договориться о знакомстве онлайн или офлайн. 
...
export function getBooksText(name: string | null) {
  return  `Чтобы вам с мэтчем было легче начать разговор, предлагаем поделиться тремя книгами, которые вы прочитали недавно и которые произвели на вас впечатление.
